    ...
    return (
        <>  
            ...
            <div className="flex justify-between items-center h-20 px-2 py-4">
                ...
                <button className="flex items-center justify-evenly transition-colors duration-300 w-40 h-15 gap-2"
                    onClick={showMenu}>
                    <div>
                    ...
                    <div className="flex justify-evenly items-center gap-3 h-10 rounded-xl px-4 py-2 bg-teal-500 text-white text-xl cursor-pointer">
                        <FaRegUserCircle />
